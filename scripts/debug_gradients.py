#!/usr/bin/env python3
"""
Debug script to test if the NaN issue occurs during gradient computation.
"""
...
def debug_gradients():
    """Debug if the NaN issue occurs during gradient computation."""
    ...
    try:
        ...
        logger.info("✅ All gradient tests passed!")
        return True
...
if __name__ == "__main__":
    success = debug_gradients()
    if success:
        logger.info("🎉 Gradient computation test PASSED! No NaN issues found.")
    else:
        logger.error("💥 Gradient computation test FAILED! Found NaN issues.")

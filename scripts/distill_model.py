...
Example command:
python3 distill_bert_crf.py --kingdom_as_token --sp_region_labels --remove_top_layers 1 --weighted_loss
...
def main_training_loop(args: argparse.ArgumentParser):
    ...
    # Note: CRF constraints removed as they are not part of the intended
